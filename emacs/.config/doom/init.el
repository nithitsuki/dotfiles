...
(doom! :input
       ...
       (treemacs +evil +projectile)          ; a project drawer, like neotree but cooler
       ...
       ;;vterm             ; disabled — use ghostel instead
       ghostel           ; ghostty-based terminal emulator
       ...
       (org +journal +habits)               ; organize your plain life in plain text
